...
$getData1 = mysqli_query($conn, "select * from `academic12` where `PRN`='$PRN'");
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color: #4e73df;">
                            <h6 class="m-0 font-weight-bold" style="color: #fff;">Academics(First Year - Second
                                Semester) </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive text-center">
                                ...
                                <a href="academics12_PDF.php?PRN=<?php echo $PRN; ?>">Download PDF</a>
                                <br>
                                <div class="button text-center">
                                    <a href="academic12.php" class="btn btn-primary btn-icon-split">
