            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="tqueries.php" id="messagesDropdown" role="button"
                                ...
                                <span class="badge badge-danger badge-counter">
                                    ...
                                    $getData2 = mysqli_query($conn, "SELECT * FROM `queries` WHERE `tid`='$TID' AND (`response` IS NULL OR `response` = '')");

                                    while ($row2 = mysqli_fetch_assoc($getData2)) {
                                        if ($row2['status'] == 'unread') {
                                            $count++; // Increment the count for each unread query
                                        }
                                    }
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                while ($row2 = mysqli_fetch_assoc($getData2)) {
                                    if ($row2['status'] == 'unread') {
                                        ?>
                                        <a class="dropdown-item d-flex align-items-center" href="tqueriess.php">
                                            ...
                                            <div class="font-weight-bold">
                                                ...
                                                <div class="small text-gray-500">
                                                    <?php echo $row2['PRN']; ?>
                                                    <p>
                                                        <?php echo date("Y-m-d H:i:s", strtotime($row2['timestamp'])); ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </a>
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="tqueriess.php">Read More
                                    Queries</a>
                            </div>
                        </li>
                ...
                <div class="container mx-auto card-container">
                    <div class="card shadow mb-4">
                        ...
                        <form action="tprofiles.php" method="post">
                            ...
                            <div class="card">
                                ...
                                <div class="profile-image">
                                    <img src="images/<?php echo $row['img']; ?>" alt="<?php echo $row['tName']; ?>">
                                </div>
                                ...
                                <div class="card-content text-center">
                                    ...
                                    <h5><strong>
                                            <?php echo "Name: ", $row['tName']; ?>
                                        </strong></h5>
                                </div><br>

                                <div class="button text-center">
                                    <a href="tedit.php" class="btn btn-primary btn-icon-split">
                                    ...
                                    <a href="tchangep.php" class="btn btn-primary btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-key"></i>
                                        </span>
                                        <span class="text">Change Password</span>
                                    </a><br><br>
                                    <a href="tassigned_students.php" class="btn btn-primary btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-users"></i>
                                        </span>
                                        <span class="text">View Assigned Students</span>
                                    </a>
                                </div><br>
