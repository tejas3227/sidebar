...
if (isset($_POST['sprn'])) {
  ...
  $getData4 = mysqli_query($conn, "select * from `academic42` where `PRN`='$PRN'");
...
<body id="page-top">
      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          <div class="card-header py-3" style="background-color: #4e73df;" data-toggle="collapse" href="#academicRecord11Table">
            <h6 class="m-0 font-weight-bold" style="color: #fff;">Academic Record 42</h6>
          </div>
  ...
  <tr>
    <th colspan="6"><h4>Academic Report (42)</h4> </th>
  </tr>
  ...
  <tr>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3" style="background-color: #4e73df;">
        <h6 class="m-0 font-weight-bold" style="color: #fff;">Generated Report(Fourth Year - Fourth Semester)</h6>
      </div>
      <div class="card-body">
        <div class="table-responsive text-center">
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
      ...
      <tr>
          ...
          <td><label for="review42"></label><?php echo $row['Review']; ?></td>
      </tr>
      <tr>
          <td>2</td>
          <td>Students attendance and his/her regularity</td>
          <td><label for="attendance42"><?php echo $row['Attendance']; ?> </td>
      </tr>
      <tr>
          <td>3</td>
          <td>Semester Result of the Earlier Semester</td>
          <td><label for="result42"></label><?php echo $row['Result']; ?></td>
      </tr>
      <tr>
          <td>4</td>
          <td>Participation in various activities(Technical/Sports/Cultural/Co-carricular)</td>
          <td><label for="carricular42"></label><?php echo $row['Carricular']; ?> </td>
      </tr>
      <tr>
          <td>5</td>
          <td>Communication and Professional Skills</td>
          <td><label for="candp42"></label> <?php echo $row['CandP_Skills']; ?> </td>
      </tr>
      <tr>
          <td>6</td>
          <td>General Behaviour and Discipline</td>
          <td><label for="behaviour42"></label> <?php echo $row['Behaviour']; ?></td>
      </tr>
      <tr>
          <td>7</td>
          <td>Any Other Specify</td>
          <td><label for="other42"></label> <?php echo $row['Other']; ?></td>
      </tr>
            </tbody>
          </table><br>
          <a href="sems_report42_PDF.php?sprn=<?php echo $selectedPRN; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                  class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                      </div>
                      <br>
          <div class="button text-center">
                      <a href="sem_report42.php?sprn=<?php echo $selectedPRN; ?>" class="btn btn-primary btn-icon-split">
