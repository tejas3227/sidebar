...
if (isset($_POST['sprn'])) {
  ...
  $getData5 = mysqli_query($conn, "select * from `academic21` where `PRN`='$PRN'");
  $row5 = mysqli_fetch_assoc($getData5);
} ?>
...
<body id="page-top">
  ...
  <tr>
    <th colspan="1"><h4>Achievements</h4> </th>
      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          <div class="card-header py-3" style="background-color: #4e73df;" data-toggle="collapse" href="#academicRecord21Table">
            <h6 class="m-0 font-weight-bold" style="color: #fff;">Academic Record 21</h6>
          </div>
          <div class="card-body collapse" id="academicRecord21Table">
            <div class="table-responsive text-center">
              <table class="table table-bordered" id="academicRecord21Table" width="100%" cellspacing="0">
                <tbody>
                <tr height="20">
    <td colspan="6">&nbsp;</td>
  </tr>
  <tr>
    <th colspan="6"><h4>Academic Report (21)</h4> </th>
  </tr>
                          ...
                          <tr>
                              ...
                              <tr>
                              <th><?php echo $row5['Course1']; ?></th>
                              <td><?php echo $row5['ISE11']; ?></td>
                              <td><?php echo $row5['ISE12']; ?></td>
                              <td><?php echo $row5['MSE1']; ?></td>
                              <td><?php echo $row5['ESE1']; ?></td>
                              <td><?php echo $row5['MAKE1']; ?></td>
                          </tr>
                          <tr>
                              <th><?php echo $row5['Course2']; ?></th>
                              <td><?php echo $row5['ISE21']; ?></td>
                              <td><?php echo $row5['ISE22']; ?></td>
                              <td><?php echo $row5['MSE2']; ?></td>
                              <td><?php echo $row5['ESE2']; ?></td>
                              <td><?php echo $row5['MAKE2']; ?></td>
                          </tr>
                          <tr>
                              <th><?php echo $row5['Course3']; ?></th>
                              <td><?php echo $row5['ISE31']; ?></td>
                              <td><?php echo $row5['ISE32']; ?></td>
                              <td><?php echo $row5['MSE3']; ?></td>
                              <td><?php echo $row5['ESE3']; ?></td>
                              <td><?php echo $row5['MAKE3']; ?></td>
                          </tr>
                          <tr>
                              <th><?php echo $row5['Course4']; ?></th>
                              <td><?php echo $row5['ISE41']; ?></td>
                              <td><?php echo $row5['ISE42']; ?></td>
                              <td><?php echo $row5['MSE4']; ?></td>
                              <td><?php echo $row5['ESE4']; ?></td>
                              <td><?php echo $row5['MAKE4']; ?></td>
                          </tr>
                          <tr>
                              <th><?php echo $row5['Course5']; ?></th>
                              <td><?php echo $row5['ISE51']; ?></td>
                              <td><?php echo $row5['ISE52']; ?></td>
                              <td><?php echo $row5['MSE5']; ?></td>
                              <td><?php echo $row5['ESE5']; ?></td>
                              <td><?php echo $row5['MAKE5']; ?></td>
                          </tr>
                          <tr>
                              <th><?php echo $row5['Course6']; ?></th>
                              <td><?php echo $row5['ISE61']; ?></td>
                              <td><?php echo $row5['ISE62']; ?></td>
                              <td><?php echo $row5['MSE6']; ?></td>
                              <td><?php echo $row5['ESE6']; ?></td>
                              <td><?php echo $row5['MAKE6']; ?></td>
                          </tr>
                          <tr>
                              <th><?php echo $row5['Course7']; ?></th>
                              <td><?php echo $row5['ISE71']; ?></td>
                              <td><?php echo $row5['ISE72']; ?></td>
                              <td><?php echo $row5['MSE7']; ?></td>
                              <td><?php echo $row5['ESE7']; ?></td>
                              <td><?php echo $row5['MAKE7']; ?></td>
                          </tr>
                          <tr>
                              <th><?php echo $row5['Course8']; ?></th>
                              <td><?php echo $row5['ISE81']; ?></td>
                              <td><?php echo $row5['ISE82']; ?></td>
                              <td><?php echo $row5['MSE8']; ?></td>
                              <td><?php echo $row5['ESE8']; ?></td>
                              <td><?php echo $row5['MAKE8']; ?></td>
                          </tr>
                          <tr>
                              <th><?php echo $row5['Course9']; ?></th>
                              <td><?php echo $row5['ISE91']; ?></td>
                              <td><?php echo $row5['ISE92']; ?></td>
                              <td><?php echo $row5['MSE9']; ?></td>
                              <td><?php echo $row5['ESE9']; ?></td>
                              <td><?php echo $row5['MAKE9']; ?></td>
                          </tr>
  ...
  <tr>
                              ...
                              <td><?php echo $row5['sgpi']; ?></td>
                              <th><label for="cgpi">CGPA</label></th>
                              <td><?php echo $row5['cgpi']; ?></td>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3" style="background-color: #4e73df;">
        <h6 class="m-0 font-weight-bold" style="color: #fff;">Generated Report (Second Year - First Semester)</h6>
      </div>
      <div class="card-body">
        <div class="table-responsive text-center">
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          $getData = mysqli_query($conn, "select * from `semrepo21` where `PRN`='$selectedPRN'");
      ...
      <tr>
          ...
          <td><label for="review21"></label><?php echo $row['Review']; ?></td>
      </tr>
      <tr>
          <td>2</td>
          <td>Students attendance and his/her regularity</td>
          <td><label for="attendance21"><?php echo $row['Attendance']; ?> </td>
      </tr>
      <tr>
          <td>3</td>
          <td>Semester Result of the Earlier Semester</td>
          <td><label for="result21"></label><?php echo $row['Result']; ?></td>
      </tr>
      <tr>
          <td>4</td>
          <td>Participation in various activities(Technical/Sports/Cultural/Co-carricular)</td>
          <td><label for="carricular21"></label><?php echo $row['Carricular']; ?> </td>
      </tr>
      <tr>
          <td>5</td>
          <td>Communication and Professional Skills</td>
          <td><label for="candp21"></label> <?php echo $row['CandP_Skills']; ?> </td>
      </tr>
      <tr>
          <td>6</td>
          <td>General Behaviour and Discipline</td>
          <td><label for="behaviour21"></label> <?php echo $row['Behaviour']; ?></td>
      </tr>
      <tr>
          <td>7</td>
          <td>Any Other Specify</td>
          <td><label for="other21"></label> <?php echo $row['Other']; ?></td>
      </tr>
            </tbody>
          </table><br>
          <a href="sems_report21_PDF.php?sprn=<?php echo $selectedPRN; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                  class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                      </div>
                      <br>
          <div class="button text-center">
                      <a href="sem_report21.php?sprn=<?php echo $selectedPRN; ?>" class="btn btn-primary btn-icon-split">
