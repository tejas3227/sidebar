                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color: #4e73df;">
                            <h6 class="m-0 font-weight-bold" style="color: #fff;">Placement</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive text-center">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><label for="d1">Drive1:</label><br></td>
                                            <td>
                                                <?php echo $row2['Drive1']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label for="d2">Drive2:</label><br></td>
                                            <td>
                                                <?php echo $row2['Drive2']; ?>
                                        </tr>
                                        <tr>
                                            <td><label for="d3">Drive3:</label><br></td>
                                            <td>
                                                <?php echo $row2['Drive3']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label for="d4">Drive4:</label><br></td>
                                            <td>
                                                <?php echo $row2['Drive4']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label for="d5">Drive5:</label><br></td>
                                            <td>
                                                <?php echo $row2['Drive5']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label for="d6">Drive6:</label><br></td>
                                            <td>
                                                <?php echo $row2['Drive6']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label for="d7">Drive7:</label><br></td>
                                            <td>
                                                <?php echo $row2['Drive7']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label for="d8">Drive8:</label><br></td>
                                            <td>
                                                <?php echo $row2['Drive8']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label for="d9">Drive9:</label><br></td>
                                            <td>
                                                <?php echo $row2['Drive9']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label for="d10">Drive10:</label><br></td>
                                            <td>
                                                <?php echo $row2['Drive10']; ?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table><br>
                                <div class="button text-center">
                                    <a href="placement.php" class="btn btn-primary btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-edit"></i>
                                        </span>
                                        <span class="text">Edit Placement Details</span>
                                    </a>
                                </div>
                            </div>
                        </div>
