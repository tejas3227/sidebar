...
$getData3 = mysqli_query($conn, "SELECT * FROM `queries` WHERE `tid`='$TID'");
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color: #4e73df;">
                            <h6 class="m-0 font-weight-bold" style="color: #fff;">Queries By Students</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="table-responsive text-center">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <tbody>
                                            ...
                                            <?php
                                            $getData3 = mysqli_query($conn, "SELECT * FROM `queries` WHERE `tid`='$TID'");
                                            while ($row3 = mysqli_fetch_assoc($getData3)) {
                                                if (empty($row3['response'])) {
                                                    echo '<tr>';
                                                    echo '<td>' . $row3['PRN'] . '</td>';
                                                    echo '<td>' . $row3['query'] . '</td>';
                                                    echo '<td>' . $row3['Date'] . '</td>';
                                                    echo '<td>' . $row3['time'] . '</td>';
                                                    echo '<td><a href="tqueries.php?prn=' . $row3['PRN'] . '" class="btn btn-primary">Response</a></td>';
                                                    echo '</tr>';
                                                }
                                            }
                                            ?>
